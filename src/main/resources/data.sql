...
insert into blog_post_entity (id, image_src, intro, mark_down_src, title)
select 2, 'https://www.linode.com/docs/development/version-control/introduction-to-version-control/1204-image_versioning_intro_1.jpg', '<div class="featured-text text-center text-lg-left">
      ...
      <p class="text-black-50 mb-0">Learn all about how I made own serve hosted versioning system</p>
       ...
       'https://ppt-productions-blog-posts.s3.us-east-2.amazonaws.com/gitBlog.md'
        , '<i>Intro to making of my self hosted versioning system.</i>'
where not exists (SELECT * FROM blog_post_entity WHERE id = 2) ;
